...
class BarcodeGeneratorHTML extends BarcodeGenerator
{
     ...
     * @public
     */
    public function getBarcode($code, $type, $widthFactor = 5, $totalHeight = 50, $color = 'black')
    {
        $barcodeData = $this->getBarcodeData($code, $type);

        $html = '<div style="margin-left:215px;font-size:0;position:relative;width:' . ($barcodeData['maxWidth'] * $widthFactor) . 'px;height:' . ($totalHeight) . 'px;">' . "\n";
