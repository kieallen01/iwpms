...
<?php include('../header.php');?>
    ...
    <div class="d-flex">
        ...
        <div class="content p-4">
            <a href="index.php" id="dashboard"><span class="fa fa-fw fa-home"></span></a>&nbsp;&nbsp;<span id="systitle">Municipal Trial Court</span>
            <span id="bauang">
                ...
                <div class="col">
                    <div class="card card-panel">
                        <div class="card-header">
                            <span class="fa fa-fw fa-list"></span> Applicants List for MTC
                            <span class="pull-right">
                                <div class="input-group input-group-sm mb-1">
                                    ...
                                    <select class="custom-select form-control-sm" id="filterMtc" name="filterMtc">
                        ...
                        <div class="card-body">
                             <div id="mtcOnProcess" class="table-responsive">
                                <table id="tblTrialApplicantList" class="table table-bordered dt-responsive nowrap" cellspacing = "0" width = "100%">
                                     <thead>
                                         <tr>
                                             <th>ID</th>
                                             <th>Name</th>
                            ...
                            <div id="mtcComplete" class="table-responsive" hidden>
                                <table id="tblTrialApplicantListComplete" class="table table-bordered dt-responsive nowrap" cellspacing = "0" width = "100%">
                                     <thead>
                                         <tr>
                                             <th>ID</th>
                                             <th>Name</th>
            ...
            <div id="remodal-view-applicantC" class="remodal" data-remodal-id="modalViewApplicantC">
            ...
            <div id="remodal-update-requirementC" class="remodal" data-remodal-id="modalUpdateRequirementC">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6" style="text-align: left !important;">
                            <form id="frmUpdateRequirementsC">
                                <p class="modal-label">Requirement Checklist </p>
                                ...
                                <br>
                                <center>
                                    <button class="btn btn-sm btn-secondary" style="width: 100%;" type="button" id="btnUpdateRequirementT" name="btnUpdateRequirementT"><span class="fa fa-fw fa-check"></span> Approve</button>
                                </center>
                            </form>                                    
                        </div>
                    </div>
